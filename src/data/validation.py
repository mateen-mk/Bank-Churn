...
class DataValidation:
    def __init__(self, 
        ...
        try:
            ...
            raise BankChurnException(f"Error during DataValidation initialization: {str(e)}", sys) from e
    ...
    def validate_number_of_columns(self, dataframe: DataFrame) -> bool:
        ...
        try:
            ...
            raise BankChurnException(f"Error in validate_number_of_columns: {str(e)}", sys) from e
    ...
    def is_column_exist(self, df: DataFrame) -> bool:
        ...
        try:
            ...
            raise BankChurnException(f"Error in is_column_exist: {str(e)}", sys) from e        
    ...
    def detect_dataset_drift(self, reference_df: DataFrame, current_df: DataFrame, ) -> bool:
        ...
        try:
            ...
            raise BankChurnException(f"Error in detect_data_drift: {str(e)}", sys) from e
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            raise BankChurnException(f"Error in initiate_data_validation: {str(e)}", sys) from e